...
# 🙏 BEM-VINDOS AO CURSO DE FORMAÇÃO
...
- **Tempo na ADMC**
- **Uma palavra que define seu serviço**
...
### FREQUÊNCIA
- ✅ Presença em todas as 5 aulas
- ✅ Mínimo 80% para certificação
...
- 🏗️ Construir, não criticar
- 🤫 Sigilo sobre discussões pessoais
...
*Aproveite para se hidratar e fazer network com os colegas!*
...
Na epístola de 3 João, encontramos personagens que representam diferentes tipos de obreiros:

1. **GAIO** - O que serve por amor
2. **Orgulhoso** - O que serve para se amostrar
3. **DIÓTREFES** - O que serve por título
4. **Interesseiro** - O que serve para crescer

**E ainda:** DEMÉTRIO - O obreiro ideal
...
- 🤫 É discreto, não fofoca
- 🙏 Ora pelo pastor e pela igreja
- 📞 Disponível quando chamado
...
- ❌ Busca lugares de destaque
- ❌ Fica magoado sem elogio
- ❌ Compara-se com outros
- ❌ Serve quando há público
- ❌ Publica tudo nas redes
...
- 😤 Reclama nos "bastidores"
- 👔 Usa ministério para status
- 🏷️ Quer título, não trabalho
...
> *"Escrevi à igreja; mas Diótrefes, que procura ter entre eles a **primazia**, não nos recebe."*  
> **3 João 9**

### Na prática:
- Quer ser "líder" sem liderar
...
- ❌ Serve enquanto convém
- ❌ Abandona sem benefício
...
- Reclama se não há promoção
- Compara com outras igrejas
...
> *"Todos dão testemunho de Demétrio, até a mesma verdade."*

### Características:
- ✅ Aprovado por todos
- ✅ Testemunhado pela verdade
- ✅ Confirmado pela liderança
- ✅ Humilde e verdadeiro
- ✅ Ama e anda na verdade
...
| Tipo | Motivação | Resultado |
|------|-----------|-----------|
| **GAIO** | Amor | Fidelidade |
| **Orgulhoso** | Aparecer | Frustração |
| **DIÓTREFES** | Poder | Divisão |
| **Interesseiro** | Ganho | Abandono |
| **DEMÉTRIO** | Verdade | Aprovação |
...
### Pergunte-se:
1. Qual tipo mais me representa **hoje**?
2. Que atitudes preciso **mudar**?
3. Como posso servir **melhor** em 2026?
4. O que **me motiva** a servir?

*Responda em silêncio - é pessoal entre você e Deus*
...
### Instruções:
1. Pegue a ficha de autoavaliação
2. Responda em silêncio
3. Seja honesto consigo mesmo
4. **Não será recolhido**

⏱️ **Tempo:** 10 minutos

*Depois teremos momento de oração*
...
### Ore em silêncio:
- Confesse o que precisa melhorar
- Peça força para mudar
- Agradeça pela oportunidade
- Comprometa-se com Deus

*"Senhor, faz de mim um obreiro aprovado!"*
...
| **2** | Pb. Adeilson | Liderança Servidora |
| **3** | Pb. Adeilson | Liderança Multiplicadora |
| **4** | Pr. Leivyson | Submissão e Dízimos |
| **5** | Pr. Leivyson | Cuidando das Crianças |
...
1. **Memorizar** 2 Timóteo 2:15
2. **Refletir** sobre seu tipo de obreiro
3. **Orar** pelos colegas do curso
4. **Aplicar** um princípio esta semana
